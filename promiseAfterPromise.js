...
// My soluition...all this time I didn't understand the exercies lol

// const logger = (context) => (...args) => console.log(context, ...args)

// const first = () => {
//   return new Promise(resolve => resolve('SECRET VALUE OF THE FIRST PROMISE'));
// }

// const second = (firstPromiseFullfiledValue) => {
//   return new Promise(resolve => resolve('SECRET VALUE OF THE SECOND PROMISE'))
// }
